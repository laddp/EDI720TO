...
public class ReceiptsTableModel extends AbstractTableModel {
	...
	private final Vector<String>      Carriers;
	...
	public ReceiptsTableModel(Vector<Transaction> transactions, Vector<Boolean> include,  Vector<String> carriers)
	{
	...
	public Object getValueAt(int row, int column) {
		...
		case 6: 
			return Carriers.elementAt(row);///.getSelectedItem().toString();
		default: 
			return null;
		}
	}
	...
	{   
        ...
        if (col == 6)
        {  
        	Carriers.set(row, value.toString());
        }
   }      
	
	public static void initColumnSizes(JTable table) {
		ReceiptsTableModel model = (ReceiptsTableModel)table.getModel();
	...
	public int getColumnNum(String columnName)
	{
		if (columnName.equals("Include"))
        	...
        	return 5;
        else if (columnName.equals("Vessel"))
        	return 6;
        else 
			return -1;
	}
